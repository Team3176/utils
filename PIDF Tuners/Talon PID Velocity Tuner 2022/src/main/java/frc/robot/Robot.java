...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    initMotorController(deviceID, kMotorInvert);
    ...
    SmartDashboard.putBoolean("Invert Lead Motor", kMotorInvert);
  ...
  private void initMotorController(int canId, boolean invert_motor) {
    ...
    deviceID = canId;
    kMotorInvert = invert_motor;

    // initialize motor
    m_motor = new TalonSRX(deviceID);
  ...
  public void teleopPeriodic() {
    ...
    boolean invert_motor = SmartDashboard.getBoolean("Invert Lead Motor", kMotorInvert);
    ...
    if ((canId != deviceID) || (invert_motor != kMotorInvert)) {
    ...
    m_motor.set(ControlMode.Velocity, reference_setpoint); 
